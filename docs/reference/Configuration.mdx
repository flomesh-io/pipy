...
_Configuration_ is what a PipyJS module is supposed to return after being evaluated. It helps user describe variables, pipelines and filters included in a module, as well as how a module interacts with other modules via variables and sub-pipelines.
