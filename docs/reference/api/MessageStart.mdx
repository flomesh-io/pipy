...
**MessageStart** marks the start of a message in an event stream. It also contains header (or meta) information for that message in its [head](/reference/api/MessageStart/head) property.
