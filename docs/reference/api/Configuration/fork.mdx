...
The layout based on which sub-pipelines are created is given by the first argument when you call `fork()`. The second argument is optional. It decides how many sub-pipelines are created, and what their [_contexts_](/concepts#context) are.
