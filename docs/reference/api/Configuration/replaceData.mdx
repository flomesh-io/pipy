...
A **replaceData** filter calls a user function to get a replacement for every [Data](/reference/api/Data) event in the input stream. Its input and output can be any kinds of events.
