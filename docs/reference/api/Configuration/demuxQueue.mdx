...
One **demuxQueue** filter can have more than one sub-pipelines, each of which handles one _Message_. Compare this to [muxQueue()](/reference/api/Configuration/muxQueue).
