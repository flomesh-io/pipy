...
A group of **muxHTTP** filters can have one shared sub-pipeline, in which many HTTP requests and responses are multiplexed. Compare this to [demuxHTTP()](/reference/api/Configuration/demuxHTTP).
