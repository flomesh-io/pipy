...
A group of **muxQueue** filters can have one shared sub-pipeline, in which many input/output _Messages_ are multiplexed. Compare this to [demuxQueue()](/reference/api/Configuration/demuxQueue).
