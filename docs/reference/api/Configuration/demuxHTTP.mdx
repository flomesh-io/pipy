...
One **demuxHTTP** filter can have more than one sub-pipelines, each of which handles one HTTP request. Compare this to [muxHTTP()](/reference/api/Configuration/muxHTTP).
