...
First, create a JSON file named "config.json" in the same way as we created "main.js" in [Part 2: Echo](/tutorial/02-echo/#create-a-pipy-codebase), only without flagging it as the program entrance. This file will contain the configurable elements in our code:
