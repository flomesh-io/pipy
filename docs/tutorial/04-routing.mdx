...
Pipy provides class [_URLRouter_](/reference/algo/URLRouter) for
...
the parameter given to [_pipy()_](/reference/pipy) at the beginning of
...
[_URLRouter.find()_](/reference/algo/URLRouter/find) to work out the value of
...
When called, [_link()_](/reference/Configuration/link) accepts one or more
...
1. Use [_algo.URLRouter_](/reference/algo/URLRouter) to map a URL-like string
