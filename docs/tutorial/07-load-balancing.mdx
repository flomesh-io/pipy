...
In this tutorial, we'll be using [_algo.RoundRobinLoadBalancer_](/reference/algo/RoundRobinLoadBalancer),
...
[_select()_](/reference/algo/RoundRobinLoadBalancer/select) method, it will
...
in [Part 5](/tutorial/05-plugins#export-and-import). It's just the same thing here too.
...
1. Use [_algo.RoundRobinLoadBalancer_](/reference/algo/RoundRobinLoadBalancer)
