...
[_Data_](/reference/api/Data) events, each holding a small chunk of
...
[_MessageStart_](/reference/api/MessageStart) and
[_MessageEnd_](/reference/api/MessageEnd) events for further processing.
