...
[_Data_](/reference/Data) events, each holding a small chunk of
...
[_MessageStart_](/reference/MessageStart) and
[_MessageEnd_](/reference/MessageEnd) events for further processing.
