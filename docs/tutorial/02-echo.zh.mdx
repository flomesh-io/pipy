...
* 点击工具栏中的 <StopIcon/> 按钮，并点击 <PlayIcon/> 按钮运行新的代码。
* 或者点击 <RestartIcon/> 按钮直接使用新的版本重启程序。
...
对于那些习惯于在整个程序中具有共享状态的全局变量的人来说，这可能是违反直觉的。有关更深入的解释，请参阅[概念中的上下文](/intro/concepts#上下文)。
