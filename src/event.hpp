...
namespace pipy
{
  ...
  private:
    ...
    MessageEnd(pjs::Object *tail, const pjs::Value &payload)
        : m_tail(tail), m_payload(payload) {}

    MessageEnd(const MessageEnd &r)
        : m_tail(r.m_tail), m_payload(r.m_payload) {}
  ...
  private:
    ...
    StreamEnd(const StreamEnd &r)
        : m_error(r.m_error), m_error_code(r.m_error_code) {}
  ...
  class SharedEvent : public pjs::RefCountMT<SharedEvent>,
