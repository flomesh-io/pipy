 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_xdp_load_bytes)(struct xdp_md *xdp_md, __u32 offset,
                                  void *buf, __u32 len) = (void *)189;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_xdp_store_bytes)(struct xdp_md *xdp_md, __u32 offset,
                                   void *buf, __u32 len) = (void *)190;
 ...
 */
static long (*bpf_skb_set_tstamp)(struct __sk_buff *skb, __u64 tstamp,
                                  __u32 tstamp_type) = (void *)192;
 ...
 * 	invalid arguments are passed.
 */
static long (*bpf_ima_file_hash)(struct file *file, void *dst,
                                 __u32 size) = (void *)193;
 ...
 */
static void *(*bpf_map_lookup_percpu_elem)(void *map, const void *key,
                                           __u32 cpu) = (void *)195;
...
static long (*bpf_dynptr_from_mem)(void *data, __u32 size, __u64 flags,
                                   struct bpf_dynptr *ptr) = (void *)197;
 ...
 * 	0 on success, or a negative error in case of failure.
 */
static long (*bpf_ringbuf_reserve_dynptr)(void *ringbuf, __u32 size,
                                          __u64 flags,
 ...
 * 	Nothing. Always succeeds.
 */
static void (*bpf_ringbuf_submit_dynptr)(struct bpf_dynptr *ptr,
                                         __u64 flags) = (void *)199;
 ...
 * 	Nothing. Always succeeds.
 */
static void (*bpf_ringbuf_discard_dynptr)(struct bpf_dynptr *ptr,
                                          __u64 flags) = (void *)200;
 ...
 * 	*flags* is not 0.
 */
static long (*bpf_dynptr_read)(void *dst, __u32 len,
                               const struct bpf_dynptr *src, __u32 offset,
 ...
 */
static long (*bpf_dynptr_write)(const struct bpf_dynptr *dst, __u32 offset,
                                void *src, __u32 len,
 ...
 * 	is out of bounds.
 */
static void *(*bpf_dynptr_data)(const struct bpf_dynptr *ptr, __u32 offset,
                                __u32 len) = (void *)203;
 ...
 */
static __s64 (*bpf_tcp_raw_gen_syncookie_ipv4)(struct iphdr *iph,
                                               struct tcphdr *th,
                                               __u32 th_len) = (void *)204;
 ...
 */
static __s64 (*bpf_tcp_raw_gen_syncookie_ipv6)(struct ipv6hdr *iph,
                                               struct tcphdr *th,
                                               __u32 th_len) = (void *)205;
 ...
 */
static long (*bpf_tcp_raw_check_syncookie_ipv4)(
 ...
 * 	**-EPROTONOSUPPORT** if CONFIG_IPV6 is not builtin.
 */
static long (*bpf_tcp_raw_check_syncookie_ipv6)(
 ...
 */
static long (*bpf_user_ringbuf_drain)(void *map, void *callback_fn, void *ctx,
                                      __u64 flags) = (void *)209;
 ...
 * 	a new bpf_local_storage.
 */
static void *(*bpf_cgrp_storage_get)(void *map, struct cgroup *cgroup,
                                     void *value, __u64 flags) = (void *)210;
 ...
 * 	**-ENOENT** if the bpf_local_storage cannot be found.
 */
static long (*bpf_cgrp_storage_delete)(void *map,
                                       struct cgroup *cgroup) = (void *)211;
